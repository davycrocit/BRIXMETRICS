# Brix Recruiting Metrics Portal - Deployment Guide (Linux/macOS)

This guide will walk you through deploying the Brix Recruiting Metrics Portal to Netlify with Supabase as the backend.

> **Windows Users**: See [DEPLOYMENT_GUIDE_WINDOWS.md](./DEPLOYMENT_GUIDE_WINDOWS.md) for Windows-specific instructions.

## Table of Contents
1. [Prerequisites](#prerequisites)
2. [Step 1: Set Up Supabase](#step-1-set-up-supabase)
3. [Step 2: Deploy to Netlify](#step-2-deploy-to-netlify)
...
1. Create a new repository on GitHub (e.g., `brix-metrics-portal`)
...
### 3.2 For Local Development (Optional)
...
**You're all set!** Your Brix Recruiting Metrics Portal should now be live and ready to use.
